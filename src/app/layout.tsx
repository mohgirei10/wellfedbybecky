  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className="bg-[#0A0503] text-[#F9F4EE] antialiased">
        ...
        <footer className="border-t border-white/8 bg-[#080403] px-6 pb-10 pt-20">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-14 md:grid-cols-12">
              {/* Brand */}
              <div className="md:col-span-5">
                <Link href="/" className="inline-flex flex-col">
                  <span className="font-serif text-3xl font-bold tracking-[0.16em] text-white">
                    WELLFED
                  </span>

                  <span className="-mt-1 font-serif text-lg italic text-[#CD9C61]">
                    by Becky
                  </span>
                </Link>
